...
def draw_score(pen, score):
    ...
    pen.goto(-150, 310)
    pen.write("Space = rotate", move=False, align="left", font=("Arial", 24, "normal"))
    pen.goto(-190, 270)
    pen.write("Arrow/WASD keys to move", move=False, align="left", font=("Arial", 24, "normal"))
